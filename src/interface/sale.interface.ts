...
export const Sale_Table: DBTable<Sale> = {
    ...
    columns: [
        {key: 'id_sale', name: 'SaleId', type: 'number', visible: true},
        {key: 'location', name: 'Location', type: 'string', visible: true},
        {key: 'sale_date', name: 'SaleDate', type: 'date', visible: true},
        {key: 'product_id', name: 'ProductId', type: 'number', visible: false},
        {key: 'seller_id', name: 'SellerId', type: 'number', visible: false},
    ],
    foreign_keys: [
        { foreign_key: 'product_id', foreign_table_id: 'id_product', foreign_table_name: 'product'}, 
        { foreign_key: 'seller_id', foreign_table_id: 'id_seller', foreign_table_name: 'seller'}
    ]
};